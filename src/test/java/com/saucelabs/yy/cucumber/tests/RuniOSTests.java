...
@CucumberOptions(
        ...
        glue = {"com.saucelabs.yy.cucumber.steps.iOS"},
        plugin = {
                "summary",
                "pretty",
...
public class RuniOSTests extends SuperTestBase {
    private TestNGCucumberRunner testNGCucumberRunner;

    public static ThreadLocal<IOSDriver> driver = new ThreadLocal<>();
    ...
    public void setUpClass(String deviceName, String platformName) throws Exception {
        ...
        capabilities.setCapability("appium:app", "storage:filename=" + "iOS-Real-Device-MyRNDemoApp.ipa");
        ...
        driver.set(new IOSDriver(new URL("https://" + username + ":" + accesskey + "@ondemand.eu-central-1.saucelabs.com/wd/hub"), capabilities));
    }
