...
public class LoginTests extends TestBase {
    ...
    public void invalidCredentials(String platform, String deviceName, String platformVersion, Method methodName) throws MalformedURLException {
        ...
        getDriver().findElement(new MobileBy.ByAccessibilityId("test-Username")).sendKeys("bad");
        getDriver().findElement(new MobileBy.ByAccessibilityId("test-Password")).sendKeys("bad");
        getDriver().findElement(new MobileBy.ByAccessibilityId("test-LOGIN")).click();
    ...
    public void blankCredentials(String platform, String deviceName, String platformVersion, Method methodName) throws MalformedURLException {
        createDriver(platform, deviceName, platformVersion, methodName.getName());
        getDriver().findElement(new MobileBy.ByAccessibilityId("test-Username")).sendKeys("");
        getDriver().findElement(new MobileBy.ByAccessibilityId("test-Password")).sendKeys("");
        getDriver().findElement(new MobileBy.ByAccessibilityId("test-LOGIN")).click();
    ...
    public void validCredentials(String platform, String deviceName, String platformVersion, Method methodName) throws MalformedURLException {
        createDriver(platform, deviceName, platformVersion, methodName.getName());
        getDriver().findElement(new MobileBy.ByAccessibilityId("test-Username")).sendKeys("standard_user");
        getDriver().findElement(new MobileBy.ByAccessibilityId("test-Password")).sendKeys("secret_sauce");
        getDriver().findElement(new MobileBy.ByAccessibilityId("test-LOGIN")).click();
