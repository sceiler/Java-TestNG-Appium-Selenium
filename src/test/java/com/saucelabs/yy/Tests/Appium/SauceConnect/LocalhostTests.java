...
public class LocalhostTests extends TestBase {
    ...
    public void openLocalRouterLoginPage(String platform, String deviceName, String platformVersion, Method methodName) throws MalformedURLException, InterruptedException {
